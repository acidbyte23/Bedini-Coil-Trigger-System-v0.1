...
void EXTI0_IRQHandler(void)
{
  /* USER CODE BEGIN EXTI0_IRQn 0 */
	...
	// Delay pulse xx microseconds
	while (__HAL_TIM_GET_COUNTER(&htim1) < delayPulse){};
	
	// Write pulse HIGH
	HAL_GPIO_WritePin(GPIOB, GPIO_PIN_1, GPIO_PIN_SET);
		
	// Wait pulse width xx microseconds
	while (__HAL_TIM_GET_COUNTER(&htim1) < totalPulseTime){};
  ...
  HAL_GPIO_EXTI_IRQHandler(Hall_Trigger_In_Pin);
